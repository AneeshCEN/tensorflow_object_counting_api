...
# Get current height of frame
    ...
    output_movie = cv2.VideoWriter('the_output.avi', fourcc, 24, (int(width), int(height)))
    ...
    with detection_graph.as_default():
      with tf.Session(graph=detection_graph) as sess:
        ...
        while(cap.isOpened()):
            ...
            if counter == 1:
              cv2.line(input_frame, (roi, 0), (roi, frame.shape[1]), (0, 0xFF, 0), 5)
            else:
              cv2.line(input_frame, (roi, 0), (roi, frame.shape[1]), (0, 0, 0xFF), 5)
            ...
            cv2.putText(
                input_frame,
                'No of Detected Persons: ' + str(total_passed_vehicle),
                (10, 35),
                font,
                0.8,
                (0, 0xFF, 0xFF),
